    ...
    for i in range(LEVELS_TO_GENERATE):
        ...
        for row in final_grid:
            ...
            for cell in row:
                ...
                elif cell == 2: line += "🐭 " # Mouse
                elif cell == 3: line += "🐱 " # Cat
                elif cell == 4: line += "🚪 " # Exit
            print(line)
        print("\n") 
        # --- VISUALIZER END ---
        ...
        print(f"✅ Level {i+1} saved to list.\n")

    # 4. Save to file
    with open(vault_file, "w") as f:
        json.dump(all_levels, f, indent=4)
    
    print(f"🎉 Boom. {LEVELS_TO_GENERATE} levels saved to '{vault_file}'. Send it to your team!")
